...
function Services({ img, title, description}) {
  return (
    <div className='cursor-pointer hover:scale-105 transform transition hover:bg-red-200 p-2 rounded-md
     duration-300 ease-out'>
        <div className='relative h-60 w-80' >
        <div className='flex flex-row items-center justify-between'>
                <h5 class="mb-2 text-2xl">{title}</h5>
                ...
                <path d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6
                 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z"/>
